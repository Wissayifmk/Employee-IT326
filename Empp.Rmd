...
|                                    | k=2                                                            | k=3                                                   | k=4                                                   |
|--------------------------------|--------------|--------------|--------------|
| Average Silhoutte width            | 0.29                                                            | 0.24                                                  | 0.21                                                  |
| total within-cluster sum of square | 39369.3                                                       | 33408.38                                             | 28836.46                                              |
| BCubed precision                   | 0.3383452                                                      | 0.3362839                                             | 0.3374109                                             |
| BCubed recall                      | 0.5123139                                                      | 0.3660838                                             | 0.2540036                                             |
...
From the results of the methods implemented on "Employees" data set we obtained the following:
 the model with the number of clusters k=2 had average silhouette width=0.29 it is the best result 
since the model with the number of clusters k=3 and 4 had average silhouette width=0.24 and 0.21 respectively 
...
For total within cluster sum results of model with the number of clusters k=2 we had a result with the value of 39369.3 this value
...
33408.38 and 28836.46 respectively, in my opinion the as the number of clusters (k) increases, 
the total within cluster sum generally decreases because the data points are closer to their cluster centroids.

BCubed precision and recall results showed that model with the number of clusters k=2 has the highest precision
with the value 0.3383452 and the highest recall with the value 0.5123139, the model with the number of clusters k=3 and 4 
had precision values of 0.3362839 and 0.3374109 respectively and the model with the number of clusters k=3 snd 4 had 
recall values of 0.3660838   and 0.2540036 respectively, A higher precision indicates that, within a cluster, 
